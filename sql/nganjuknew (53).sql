...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Nov 2024 pada 02.15
...
--
DELIMITER $$
CREATE TRIGGER `update_total` BEFORE UPDATE ON `detail_tiket` FOR EACH ROW BEGIN
...
(9, 'bahrulahmad@gmail.com', 'bahrul testing', 'admin', '$2y$10$7AcxgYJwWdyHwhTTbGwJq.DnTKSIRBb.TDlK9s8qGdDWvY.5C1CbC', 'Nganjuk sini aja', '9_1729345424.jpg', NULL, NULL, 'active', NULL, '', NULL, NULL),
(39, 'igvi@gmail.com', 'igvi', 'user', '$2y$10$5L3JlK3OyKhB6F7Khp0UsuvxY6RAdm31gqgf9WiT8Lo1f5NR69Jei', 'Bagor', 'igvi.png', NULL, NULL, 'active', NULL, '085606650827', '5d7b65e55d9a16aed84c872c757a0cf3', '2024-11-08 01:36:04');
...
--
ALTER TABLE `detail_wisata`
  MODIFY `id_wisata` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
-- Event
--
CREATE DEFINER=`root`@`localhost` EVENT `delete_expired_tokens` ON SCHEDULE EVERY 1 MINUTE STARTS '2024-10-26 00:36:33' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    UPDATE user
    SET token = NULL
