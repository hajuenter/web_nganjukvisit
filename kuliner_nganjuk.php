...
$conn = $koneksi;
// Query untuk mengambil data dari tabel detail_kuliner
$query = "SELECT id_kuliner, nama_kuliner, deskripsi, harga, gambar, alamat FROM detail_kuliner";
    ...
    <div class="overflow-hidden">
        ...
        <div class="container my-5" style="padding-top: 3.8rem;">
            <h2 class="text-center fw-bold mb-4" data-aos="fade-zoom-in"
                ...
                data-aos-delay="200"
                data-aos-offset="0">Kuliner Nganjuk</h2>
            <div class="row g-4">
                <?php foreach ($kuliner_data as $kuliner):
                    $gambarList = explode(',', $kuliner['gambar']); // Memisahkan string gambar menjadi array
                ?>
                    <div class="col-md-4" data-aos="fade-up"
                        data-aos-duration="1500">
                        <div class="card hvr-grow shadow-sm" style="min-height: 600px;">
                            <div id="carousel-kuliner-<?php echo $kuliner['id_kuliner']; ?>" class="carousel slide" data-bs-ride="carousel">
                                <!-- Indicators -->
                                <div class="carousel-indicators">
                                    <?php foreach ($gambarList as $index => $gambar): ?>
                                        <button type="button" data-bs-target="#carousel-kuliner-<?php echo $kuliner['id_kuliner']; ?>" data-bs-slide-to="<?php echo $index; ?>" class="<?php echo $index === 0 ? 'active' : ''; ?>" aria-current="true" aria-label="Slide <?php echo $index + 1; ?>"></button>
                                    <?php endforeach; ?>
                                </div>
                                ...
                                <div class="carousel-inner">
                                    <?php foreach ($gambarList as $index => $gambar): ?>
                                        <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                                            <img src="public/gambar/<?php echo htmlspecialchars($gambar); ?>" class="img-fluid" style="aspect-ratio: 16 / 9;" alt="<?php echo htmlspecialchars($kuliner['nama_kuliner']); ?>">
                                        </div>
                                    <?php endforeach; ?>
                                </div>

                                <!-- Controls -->
                                <button class="carousel-control-prev" type="button" data-bs-target="#carousel-kuliner-<?php echo $kuliner['id_kuliner']; ?>" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-bs-target="#carousel-kuliner-<?php echo $kuliner['id_kuliner']; ?>" data-bs-slide="next">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><strong>Nama:</strong> <?php echo htmlspecialchars($kuliner['nama_kuliner']); ?></h5>
                                <p class="card-text"><strong>Deskripsi:</strong> <?php echo htmlspecialchars($kuliner['deskripsi']); ?></p>
                                <p><strong>Harga:</strong> <?php echo htmlspecialchars($kuliner['harga']); ?></p>
                                <p><strong>Alamat:</strong> <?php echo htmlspecialchars($kuliner['alamat']); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
