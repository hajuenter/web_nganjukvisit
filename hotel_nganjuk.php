    ...
    <div class="overflow-hidden">
        ...
        <div class="container my-5" style="padding-top: 3.8rem;">
            <h2 class="text-center fw-bold mb-4" data-aos="fade-zoom-in"
                ...
                data-aos-delay="200"
                data-aos-offset="0">Penginapan Nganjuk</h2>
            <div class="row g-4">
                ...
                ?>
                    <div class="col-md-4" data-aos="fade-up"
                        ...
                        <div class="card hvr-grow shadow-sm" style="min-height: 650px;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><strong>Nama:</strong> <?php echo htmlspecialchars($penginapan['nama_penginapan']); ?></h5>
                                <p class="card-text"><strong>Deskripsi:</strong> <?php echo htmlspecialchars($penginapan['deskripsi']); ?></p>
